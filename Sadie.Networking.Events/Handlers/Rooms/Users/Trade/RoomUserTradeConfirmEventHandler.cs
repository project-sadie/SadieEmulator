...
public class RoomUserTradeConfirmEventHandler(IRoomRepository roomRepository, IDbContextFactory<SadieContext> dbContextFactory) : INetworkPacketEventHandler
{
