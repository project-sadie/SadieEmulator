...
public class NewNavigatorCollapsedCategories : NetworkPacketWriter
{
    public NewNavigatorCollapsedCategories() : base(ServerPacketIds.NewNavigatorCollapsedCategories)
    {
        WriteInt(46);
        WriteString("new_ads");
