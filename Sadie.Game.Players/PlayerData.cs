...
{
    protected PlayerData(long id, string username, long homeRoom, string figureCode, string motto, PlayerAvatarGender gender, PlayerBalance balance, DateTime lastOnline, long respectsReceived, long respectPoints, long respectPointsPet, PlayerNavigatorSettings navigatorSettings) : base(figureCode, motto, gender)
    {
        Id = id;
        Username = username;
        HomeRoom = homeRoom;
